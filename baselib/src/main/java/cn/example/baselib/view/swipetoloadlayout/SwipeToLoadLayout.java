package cn.example.baselib.view.swipetoloadlayout;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    /**
     * initOnCreate touch action down point.y
     */
    private float mInitDownY;

    /**
     * initOnCreate touch action down point.x
     */
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                // anyway: handle action down in onInterceptTouchEvent() to initOnCreate is an good option
                break;
